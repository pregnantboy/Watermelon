...
{
    if (index==1){
        return [UIColor colorWithRed:210/255.0 green:215/255.0 blue:211/255.0 alpha:1];
    }
    if (index==0){
        return [UIColor colorWithRed:42/255.0 green:167/255.0 blue:208/255.0 alpha:1];
    }
